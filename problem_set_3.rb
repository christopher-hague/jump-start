# ***********************************
# Write a method that takes an array of numbers as input and uses
# #select to return an array only of even numbers
...
# ***********************************
# Write a method that takes an array of numbers as input and uses
# #reject to return an array of number that aren't odd
...
# ************************************
# Write a method that takes an array of integers and returns an array of
# those values doubled. This method should *not* modify the original
# array
...
# ************************************
# Write a method that takes an array of numbers as input and returns the
# sum of each element multiplied by its index. For example, [2, 9, 7]
# would return 23, since (2 * 0) + (9 * 1) + (7 * 2) = 0 + 9 + 14 = 23

def array_sum_with_index(array)
  array.map.each_with_index { |n, i| n * i }.reduce(0) { |s,n| s += n }
end
...
# ************************************
# Write a method that uses sort to implement the max function. Your
# method should take an array as input and return the element with the
# maximum value, calling sort once.
...
# ************************************
# Write a method that uses sort to implement the min function. Your
# method should take an array as input and return the element with the
# minimum value, calling sort once.
...
# returns the longest word.  If there is more than one word of that
# length, it should return the first instance of that word.

def longest_word(string)
  string.split(" ").max_by { |w| w.length }
end
...
# ************************************
# Write a method that takes a string and counts the number of vowels in
# the string.  For our purposes, "y" counts as a vowel. You might want
# to use the Array#include? method for this.  The usage is:
...
def count_vowels(string)
  ...
  string.each_char do |char|
    result += 1 if vowels.include?(char)
  end
  result
end
...
# ************************************
# Write a method that takes a string of words separated by spaces and
# returns a string the same as the original, but with five-letter words
# replaced with "#####"
...
# count "y" as a vowel. Assume all letters are lower case.
...
def most_common_vowel(string)
  ...
  vowel_count.key(vowel_count.values.max)
end
...
puts most_common_vowel("cat dog octopus spider") == "o" end
